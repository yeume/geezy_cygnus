...
#define VIAL_KEYBOARD_UID {0x07, 0xF5, 0x94, 0xF7, 0xC1, 0xEF, 0x38, 0xDA}
#define NO_BOOTMAGIC
#define MASTER_LEFT //left half of the keyboard is the master
#define SOFT_SERIAL_PIN GP1 //this tells which pin on the microcontroller will be used for data transmission between the keyboard halves. Refer to the pro micro controller image inside the pictures folder. D0 is pin 3 on the microcontroller.
#define SERIAL_DEBUG
